						...
						for(Clients cli : this.clients_list){	
							...
							if(test == false){
								...
								for(Clients client : this.clients_list){
									...
									if(!first_player){
										client.printString("Le joueur "+client_precedent.getName()+" a mis� "+(int)mise_precedente.get(0)+" d�s de "+(int)mise_precedente.get(1)+".");
									}
								}
								...
								if (client_choice.get(0) == 0){
									...
									for(Clients client_message : this.clients_list){
										client_message.printString(cli.getName()+" a mis� "+client_choice.get(0)+"-"+client_choice.get(1)+".");
									}
								}
